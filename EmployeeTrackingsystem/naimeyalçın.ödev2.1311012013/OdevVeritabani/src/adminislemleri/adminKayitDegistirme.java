 ...
 */
package adminislemleri;

import arayuz.adKullanıcıekle;
...
import kullaniciislemleri.*;

/**
 *
 * @author Cihanq
 */
public class adminKayitDegistirme extends javax.swing.JFrame {

    /**
     * Creates new form KayitDegistirme
     */
    public adminKayitDegistirme() {
        initComponents();
        tabloGuncelle();
    }
    ...
    public void personelEkle() {
        ...
        try {
            arayuz.adKullanıcıekle personel = new arayuz.adKullanıcıekle(
                    sicilNoTf.getText(),
                    adTf.getText(),
                    soyadTf.getText(),
                    tcNoTf.getText(),                    
                    ...
                    sehirTf.getText(),
                    kadi_güncel_tf.getText(),
                    sifre_güncel_tf.getText()
    ...
    public void textFieldTEmizle() {
        ...
        sehirTf.setText("");
        kadi_güncel_tf.setText("");
        sifre_güncel_tf.setText("");
    }
    ...
    private void initComponents() {
        ...
        k_adi_güncel = new javax.swing.JLabel();
        jLabel10 = new javax.swing.JLabel();
        kadi_güncel_tf = new javax.swing.JTextField();
        sifre_güncel_tf = new javax.swing.JTextField();
        ...
        k_adi_güncel.setText("Kullanıcı Adı");

        jLabel10.setText("Sifre");

        kadi_güncel_tf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kadi_güncel_tfActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(k_adi_güncel))
                                .addGap(43, 43, 43)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(kadi_güncel_tf)
                                    .addComponent(sifre_güncel_tf))))))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(k_adi_güncel)
                    .addComponent(kadi_güncel_tf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(sifre_güncel_tf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(temizleBtn, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(guncelleBtn, javax.swing.GroupLayout.Alignment.TRAILING))
    ...
    private void geriDonBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_geriDonBtnActionPerformed
        // TODO add your handling code here:
        this.dispose();
        new arayuz.islemler().setVisible(true);
    ...
    private void silBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_silBtnActionPerformed
        // TODO add your handling code here:
        personelSil(tablom.getValueAt(tablom.getSelectedRow(), 4).toString());
    ...
    private void guncelleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleBtnActionPerformed
        ...
        personelGuncelle(
                ...
                kadi_güncel_tf.getText(),
                sifre_güncel_tf.getText(),
                tablom.getValueAt(tablom.getSelectedRow(), 4).toString());
    ...
    private void tablomMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablomMousePressed
        ...
        kadi_güncel_tf.setText(tablom.getValueAt(tablom.getSelectedRow(), 7).toString());
        sifre_güncel_tf.setText(tablom.getValueAt(tablom.getSelectedRow(), 8).toString());
    }//GEN-LAST:event_tablomMousePressed

    private void kadi_güncel_tfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kadi_güncel_tfActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_kadi_güncel_tfActionPerformed
    ...
    private javax.swing.JLabel k_adi_güncel;
    private javax.swing.JTextField kadi_güncel_tf;
    private javax.swing.JTextField sehirTf;
    private javax.swing.JTextField sicilNoTf;
    private javax.swing.JTextField sifre_güncel_tf;
