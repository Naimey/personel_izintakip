 ...
 * @author Cihanq
 */
public class kullkayitdegistirme extends javax.swing.JFrame {

    /**
     * Creates new form KayitDegistirme
     */
    public kullkayitdegistirme() {
        initComponents();
        tabloGuncelle();
    }
    ...
    public void personelGuncelle(String ad, String soyad, String tcNo, String sicilNo,
        ...
        try {
            ...
            String sql = "UPDATE personel SET " + 
                    ...
                    "',k_adi='"+kadi+
                    "'sifre='"+sifre+
                    "' WHERE tc_no=" + guncellenecekVeriId;
    ...
    private void initComponents() {
        ...
        sifre_tf = new javax.swing.JTextField();
    ...
    private void tablomMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablomMousePressed
        ...
        kadi_tf.setText(tablom.getValueAt(tablom.getSelectedRow(), 5).toString());
        sifre_tf.setText(tablom.getValueAt(tablom.getSelectedRow(), 6).toString());
    ...
    private javax.swing.JTextField sifre_tf;
